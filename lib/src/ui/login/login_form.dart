...
import 'package:dr24/src/ui/login/create_account_button.dart';
import 'package:dr24/src/ui/login/login_button.dart';
            ...
            child: ListView(
              children: <Widget>[
                ...
                TextFormField(
                  ...
                  autocorrect: false,
                  validator: (_){
                    return !state.isPasswordValid? 'La contraseña debe tener al menos 6 caracteres': null;
                  },
                ),
                Padding(
                  padding: EdgeInsets.symmetric(vertical: 20),
